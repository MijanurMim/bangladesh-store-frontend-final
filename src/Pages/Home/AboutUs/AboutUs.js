        ...
        <div id='aboutus' className='about-section '>
            ...
            <div className='about-text border ' >
                <div className='w-100 mx-auto p-5 '>
                    <h1 style={{ fontFamily: ' Dancing Script,cursive', fontSize: 45, fontWeight: 'bold', display: 'block' }} className="aboutus-h1 mx-auto">About Us</h1>
